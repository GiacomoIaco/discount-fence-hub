...
export default function OverviewTab() {
  ...
  const { data: priceChanges = { material: [], labor: [] } } = useQuery({
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          ...
          <div className="text-2xl font-bold text-gray-900">
            {priceChanges.material.length + priceChanges.labor.length}
          </div>
          <div className="flex items-center gap-2 mt-1">
            <span className="text-xs text-blue-600">{priceChanges.material.length} materials</span>
            <span className="text-xs text-gray-300">|</span>
            <span className="text-xs text-purple-600">{priceChanges.labor.length} labor</span>
          </div>
        </div>
      </div>
