// Project Size Analysis Tab - Win rate by project size (API Version)
// Shows: Win rate by revenue bucket, Salesperson x Size matrix

import { DollarSign, TrendingUp, TrendingDown, Minus } from 'lucide-react';
import { useApiResidentialBucketMetrics } from '../../../../hooks/jobber/residential';
...
export function ProjectSizeAnalysis({ filters }: ProjectSizeAnalysisProps) {
  const { data: sizeMetrics, isLoading } = useApiResidentialBucketMetrics(filters);
          ...
          <div>
            ...
            <div className="text-sm text-emerald-700 mt-1">
              {bestSize ? (
                ...
                'Run Jobber API sync to see project size insights.'
              )}
            </div>
          </div>
        </div>
