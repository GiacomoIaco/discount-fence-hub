// Speed to Quote Analysis Tab - Key insight: faster quotes = higher win rates (API Version)
...
import { useApiResidentialSpeedMetrics, useApiResidentialSpeedSizeMatrix } from '../../../../hooks/jobber/residential';
...
export function SpeedToQuoteAnalysis({ filters }: SpeedToQuoteAnalysisProps) {
  ...
  const { data: matrixData } = useApiResidentialSpeedSizeMatrix(filters);
