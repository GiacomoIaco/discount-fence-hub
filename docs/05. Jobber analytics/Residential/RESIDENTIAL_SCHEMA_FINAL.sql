-- ============================================
-- RESIDENTIAL DIVISION - FINAL SCHEMA
-- Simplified: Quotes + Jobs + Requests (assessment date only)
-- ============================================
...
CREATE POLICY "Allow authenticated access" ON jobber_residential_opportunities FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Allow authenticated access" ON jobber_residential_quotes FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Allow authenticated access" ON jobber_residential_jobs FOR ALL TO authenticated USING (true) WITH CHECK (true);
