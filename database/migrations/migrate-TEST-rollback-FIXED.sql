-- ============================================
-- TEST RUN: Drop sales_reps table (FIXED VERSION - DRY RUN)
-- ============================================
--
...
BEGIN
  ...
  RAISE NOTICE '  • Clean up % invalid user references', null_photo_count;
  ...
  RAISE NOTICE 'migrate-PRODUCTION-commit-FIXED.sql';
  RAISE NOTICE '========================================';
END $$;
