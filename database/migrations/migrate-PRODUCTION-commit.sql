-- ============================================
-- PRODUCTION RUN: Drop sales_reps table (MAKES PERMANENT CHANGES)
-- ============================================
--
-- ⚠️ THIS WILL MAKE PERMANENT CHANGES TO YOUR DATABASE ⚠️
--
-- PREREQUISITES:
-- 1. You must have run migrate-TEST-rollback.sql successfully first
-- 2. The test run should have completed without errors
-- 3. You have reviewed the expected changes
--
-- This script will:
-- - Drop the legacy sales_reps table permanently
-- - Update 9 tables to reference auth.users instead
-- - Backfill user_profiles for all auth.users
-- - Fix the "Unknown" user issue
--
-- ============================================
