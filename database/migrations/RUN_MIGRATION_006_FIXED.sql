-- ============================================
-- PHASE 2: Group Conversations Migration (FIXED)
-- ============================================
...
DECLARE
  ...
  participant_id UUID;
BEGIN
  -- Validate that we have at least 1 participant (plus creator)
...
-- 3. DROP and recreate get_user_conversations to include group info
...
-- 4. Create function to get conversation participants
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE 'Next: Test the feature in your app!';
  RAISE NOTICE '========================================';
END $$;
