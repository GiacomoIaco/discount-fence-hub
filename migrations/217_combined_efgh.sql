-- Combined Migration 217e, 217f, 217g, 217h
-- Run this in Supabase SQL Editor
-- https://supabase.com/dashboard/project/mravqfoypwyutjqtoxet/sql/new

-- ============================================
-- 217e: Request Hub (Internal Tickets) <-> FSM Connection
-- ============================================
...
FROM jobs j
JOIN crews c ON j.assigned_crew_id = c.id
...
-- Done!
-- ============================================
SELECT 'Migrations 217e, 217f, 217g, 217h applied successfully!' as result;
