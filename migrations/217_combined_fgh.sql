-- Combined Migration 217f, 217g, 217h
-- Skipping 217e (Ticket Hub) since tickets table doesn't exist yet
...
-- Done!
-- ============================================
SELECT 'Migrations 217f, 217g, 217h applied successfully!' as result;
