-- ============================================
-- Migration 079b: Component System Fix
-- ============================================
-- Run this if 079 had errors. Drops and recreates cleanly.

-- Drop existing objects first (in reverse order of dependencies)
DROP VIEW IF EXISTS sku_components_view;
DROP FUNCTION IF EXISTS get_component_materials(UUID, UUID, TEXT);
